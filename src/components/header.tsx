...
export function Header() {
  ...
  return (
    <Navbar onMenuOpenChange={setIsMenuOpen} maxWidth="full" className="px-5 py-3 flex items-center justify-center">
      <NavbarContent justify="start" className="md:pl-20">
        ...
        <NavbarBrand className="md:w-full">
          <Image src="/logo-rama-sbg.png" alt="logo rama" width={200} height={200} />
